...
Deploy `Qwen/Qwen3.5-9B` on Akash with `vllm/vllm-openai:nightly-c86b17cfe663afb46a46b8081e9fd4c81dc920a2` and expose an OpenAI-compatible API on port `8000`.
