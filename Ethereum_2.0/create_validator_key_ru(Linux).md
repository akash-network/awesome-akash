...
8. Установите пароль для хранилища ключей (**ВНИМАНИЕ, ПАРОЛЬ ОТ ХРАНИЛИЩА КЛЮЧЕЙ ПОНАДОБИТСЯ ПРИ РАЗВЕРТЫВАНИИ НОДЫ! СОХРАНИТЕ ЕГО!**)
...
Внимательно скопируйте и сохраните выводы команд в текстовый файл, они понадобятся при заполнении файла `deploy.yml`.
