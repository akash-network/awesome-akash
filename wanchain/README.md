...
ETHEREUM OPTIONS:
  ...
  --datadir value                     Data directory for the databases and keystore (default: "/root/.wanchain")
  ...
  --networkid value                   Explicitly set network id (integer)(For testnets: use --testnet instead) (default: 1)
  --mainnet                           Ethereum mainnet
  --goerli                            Görli network: pre-configured proof-of-authority test network
  --rinkeby                           Rinkeby network: pre-configured proof-of-authority test network
  --testnet                           Testnet network: pre-configured POS test network
  --pluto                             Pluto network: pos private network
...
TRANSACTION POOL OPTIONS:
  ...
  --txpool.accountslots value         Minimum number of executable transaction slots guaranteed per account (default: 2048)
  --txpool.globalslots value          Maximum number of executable transaction slots for all accounts (default: 51200)
  --txpool.accountqueue value         Maximum number of non-executable transaction slots permitted per account (default: 8192)
...
NETWORKING OPTIONS:
  ...
  --port value                        Network listening port (default: 17717)
...
MINER OPTIONS:
  ...
  --miner.gaslimit value              Target gas ceiling for mined blocks (default: 50000000)
