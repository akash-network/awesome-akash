...
Please note the balance indicated is denominated in uACT (AKT * 10^-6), in the above example, the account has a balance of *93 AKT\*. We're now setup to deploy.
...
In the above example, we can see that a lease is created using for _51 uact_ or _0.0000051 AKT_ per block to execute the container.
