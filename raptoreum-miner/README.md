...
[![Deploy on Akash](https://raw.githubusercontent.com/akash-network/console/refs/heads/main/apps/deploy-web/public/images/deploy-with-akash-btn.svg)](https://console.akash.network/new-deployment?step=edit-deployment&templateId=akash-network-awesome-akash-raptoreum-miner)
...
2. Open [Akash Console](https://console.akash.network/new-deployment) and import your ACT wallet address from Keplr.
3. [Fund your wallet](#Quickest-way-to-get-more-ACT)
...
# How does this work?
Akash uses its blockchain to manage your container deployment and accounting.  To deploy on Akash you will need to fund your wallet with at least 10 ACT (~$20)  Each time you create a deployment, 5 ACT will be used for escrow and to fund the deployment.  If the deployment is cancelled the balance of the escrow is returned to you.  You can spin up deployments without worrying about any long term contracts and you can cancel anytime.
...
# Quickest way to get more ACT
To fund your deployment you will need ACT in your account.  The fastest way to do that is as follows:

## Buy on an Exchange
1. Install [Keplr](https://chrome.google.com/webstore/detail/keplr/dmkamcknogkgcdfhhbddcghachkejeap?hl=en)
2. Buy ACT on an [exchange](https://www.coingecko.com/en/coins/akash-network#markets)
3. Withdraw your ACT to your Keplr wallet.

## Swap from `ATOM` to `ACT`
1. Install [Keplr](https://chrome.google.com/webstore/detail/keplr/dmkamcknogkgcdfhhbddcghachkejeap?hl=en)
...
5. Now go back to [Osmosis Homepage](https://app.osmosis.zone/assets) and select `ATOM > ACT` to complete the swap
   This step swaps your ATOM you deposited onto the Osmosis platform into any other supported coin.
7. Return to the [Osmosis Assets](https://app.osmosis.zone/assets) page to withdraw your ACT to your Keplr wallet
   This step withdraws ACT from the Osmosis platform back into your Keplr wallet.  You can now send ACT to Akash Console.
